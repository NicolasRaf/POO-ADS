...
function optionSelector(option, bank) {
    ...
    switch (option) {
        ...
        case 10:
            ...
            bank.linkClientToAccount(accountNumber, searchedCPF);
            break;
        case 11:
            searchedCPF = (0, io_1.getText)("Informe o CPF do cliente: ");
            let keepAccounts = (0, io_1.getText)("Deseja manter as contas do cliente?(S/N): ");
            if (keepAccounts.toUpperCase() === "N") {
            }
            bank.deleteClient(searchedCPF);
            break;
        default:
