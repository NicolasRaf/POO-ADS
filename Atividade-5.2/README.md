...
```
Conta consultada pelo número A-111:
Account {
  id: 1,
  accNumber: 'A-111',
  balance: 1000,
...
### 3ª Questão - [Codigo](https://github.com/NicolasRaf/POO-ADS/blob/53396ea0e3b52dbbbb0647fa72593f2e400616b4/Atividade-5.2/src/apps/app.ts) com Menu.
