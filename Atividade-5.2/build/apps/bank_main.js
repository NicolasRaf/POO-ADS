...
function main() {
    ...
    // Criar clientes
    let client1 = new index_1.Client(1, "Ely Miranda", "123.456.789-00", new Date("1990-01-01"), []);
    let client2 = new index_1.Client(2, "Nicolas Rafael", "654.789.321-15", new Date("2006-06-13"), []);
    // Inserir clientes no banco
    testBank.insertClient(client1);
    testBank.insertClient(client2);
    // Criar contas
    let account1 = new index_1.Account(1, "A-111", 1000, client1);
    let account2 = new index_1.Account(2, "B-222", 500, client2);
    ...
    console.log(account1.checkBalance());
    let client3 = new index_1.Client(2, "Silvio Santos", "000.111.222-33", new Date("1930-12-12"), []);
    testBank.insertClient(client3);
    let account3 = new index_1.Account(2, "C-333", 9999999, client3);
